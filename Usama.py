...
pop_cluster.to_csv('clusters_results.csv',drop=True)
...
plt.title('Total Population', fontweight='bold', fontsize=13)
plt.xlabel('1991', fontweight='bold', fontsize=13)
plt.ylabel('2021', fontweight='bold', fontsize=13)
plt.legend()
plt.show()
...
plt.xlabel("Year(China)", fontweight='bold', fontsize=13)
plt.ylabel("Population(China)",fontweight='bold', fontsize=13)
plt.legend()
plt.title('China', fontweight='bold', fontsize=13)
plt.show()
...
plt.xlabel("Year(United States)", fontweight='bold', fontsize=13)
plt.ylabel("Population(United States)", fontweight='bold', fontsize=13)
...
plt.xlabel('Year(Ghana)', fontweight='bold', fontsize=14)
plt.ylabel('Population(Ghana)', fontweight='bold', fontsize=14)
plt.legend(loc='upper left')
...
plt.xlabel("Year(China)", fontweight='bold', fontsize=14)
plt.ylabel("Population(China)", fontweight='bold', fontsize=14)
plt.legend()
